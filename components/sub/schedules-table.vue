<template>
  <div class="rounded-lg pl-4 py-5 md:ml-4 lg:mr-8">
    ...
    <div class="border-solid border border-b-0 border-outline-gray min-w-full bg-header-gray divide-y divide-gray-200 text-sm py-2 px-4">
      <input class="inline-block w-64 p-2 border-solid border border-outline-gray rounded" type="text" name="" v-model="activeSearch" placeholder="Search for Schedules Name or ID" @change="setSearchTerm(activeSearch)">
    </div>
    ...
    <div class="overflow-hidden overflow-x-auto">
      <table class="min-w-full rounded bg-white divide-y divide-gray-200 text-sm table-auto">
        ...
        <!-- This is here to show dummy code usage for testing from the vuex store -->
        <template v-if="viewPerPage === 10">
          <tbody
...
const { mapState, mapGetters, mapMutations } = createNamespacedHelpers('schedules/schedules');
